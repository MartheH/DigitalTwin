...
namespace AQUAS_Lite
{
    ...
    public class AQUAS_Lite_Reflection : MonoBehaviour
    {
        ...
        void OnPreCull()
        {
            ...
            if (!cam || cam.name.Contains("Preview") || !enabled || !gameObject.activeInHierarchy)
                return;
        ...
        private void RenderReflection(Camera cam)
        {
            ...
            Matrix4x4 mtx = transform.localToWorldMatrix * Matrix4x4.Scale(new Vector3(1f / scale.x, 1f / scale.y, 1f / scale.z));
